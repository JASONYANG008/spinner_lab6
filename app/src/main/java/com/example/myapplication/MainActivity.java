...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] transNameArray = new String[]{"脚踏车", "机车", "汽车", "巴士"};
        ...
        spinner.setAdapter(transAdapter);           //spinner

        String[] messageArray = new String[]{"NO1", "NO2", "NO3", "NO4", "NO5", "NO6"};
        ...
        String[] cubeeNameArray = new String[]{"哭泣", "发抖", "再见", "生气", "晕倒", "窃笑",
                "很棒", "你好", "惊吓", "大笑"};
